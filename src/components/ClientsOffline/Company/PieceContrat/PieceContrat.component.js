...
const PieceContratCompanyOffComponent = ({ navigation, route, lib }) => {
    const {
        nativebase,
        reactNative,
        MaterialIcons,
    ...
    const nextPage = (param) => {
        if (
            ...
            navigation.navigate('RecapInfoCompanyOff')
        }
    }
...
export default withHOC(PieceContratCompanyOffComponent);
