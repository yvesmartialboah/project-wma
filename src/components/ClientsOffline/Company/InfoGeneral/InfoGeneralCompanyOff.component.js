...
const InfoGeneralCompanyOffComponent = ({ navigation, route, lib }) => {
    const {
        nativebase,
        reactNative,
        MaterialIcons,
    ...
    const [codeNumberEntr, setCodeNumberEntr] = useState(null);
    const [codeNumberRep, setCodeNumberRep] = useState(null);
    ...
    const nextPage = (param) => {
        if(dispatch(
            updateInfoCompany(1,{
                numero_tel: codeNumberEntr + param.numero_tel,
                ...
                contact_rep_legal: codeNumberRep + param.contact_rep_legal,
                email: param.email,
                fax: param.fax,
            })
        )){
            navigation.navigate('SitGeoContactCompanyOff')
        }
    }
                            ...
                            <FormControl isRequired isInvalid={(errors.numero_tel && touched.numero_tel)}>
                                <View style={stylesInfoGeneralP.parentinputNum}>
                                    <View style={stylesInfoGeneralP.soninputNum}>
                                        <Text style={{color: 'gray'}}> Numéro Entreprise </Text>
                                        ...
                                        <PhoneInput
                                            ...
                                            onChangeFormattedText={(text)=>{
                                                ...
                                                setCodeNumberEntr(textInput.current.state.code)
                                            }}
                                            // disabled={false}
                                            // withDarkTheme
                                            withShadow
                            ...
                            <FormControl isRequired isInvalid={(errors.contact_rep_legal && touched.contact_rep_legal)}>
                                <View style={stylesInfoGeneralP.parentinputNum}>
                                    <View style={stylesInfoGeneralP.soninputNum}>
                                        ...
                                        /> */}
                                        <Text style={{color: 'gray'}}> Contact du représentant </Text>
                                        <PhoneInput
                                            // withShadow={true}
                                            containerStyle={stylesInfoGeneralP.phonestyle}
                                            ref={textInput}
                                            ...
                                            onChangeFormattedText={(text)=>{
                                                // console.log(text, 'code')
                                                // console.log(textInput.current.state.code, 'current')
                                                setCodeNumberRep(textInput.current.state.code)
                                            }}
                                            // disabled={false}
                                            // withDarkTheme
                                            withShadow
...
export default withHOC(InfoGeneralCompanyOffComponent);
