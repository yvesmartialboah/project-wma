...
const PieceContratParticularComponent = ({ navigation, route, lib }) => {
    const {
        nativebase,
        reactNative,
        MaterialIcons,
    ...
    const nextPage = (param) => {
        if (
            ...
            navigation.navigate('RecapInfoParticular',{
                img: {
...
export default withHOC(PieceContratParticularComponent);
