...
const SitGeoContactCompanyOffComponent = ({ navigation, route, lib }) => {
    const {
        nativebase,
        reactNative,
        MaterialIcons,
    ...
    useEffect(() => {
        hideSplash();
        // navigation.navigate('PieceContratCompanyOff', {
        //     reload: {
        //         date: new Date()
        //     }
        // })
...
export default withHOC(SitGeoContactCompanyOffComponent);
