...
const SitGeoContactParticularOfflineComponent = ({ navigation, route, lib }) => {
    const {
        nativebase,
        reactNative,
        MaterialIcons,
    ...
    const nextPage = (param) => {
        if (
            ...
            navigation.navigate('PieceContratParticularOffline', {
                reload: {
                    date: new Date()
                }
            })
                        ...
                        <Stack space={5} mt={0} height={'80%'}>
                            ...
                            <View style={stylesInfoGeneralP.Vtitle}>
                                <View style={stylesInfoGeneralP.V2title}>
                                    ...
                                    >
                                        2 - Situation Géographique Hors-connexion
                                    </Text>
                                </View>
                            </View>
                            ...
                            {/* Autre Numero de téléphone - Autre tel */}
...
export default withHOC(SitGeoContactParticularOfflineComponent);
